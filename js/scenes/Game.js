 ...
 *
 * @question - Може є якесь простіше на стандартне рішення, яке визначено
 ...
 * onComplete в tween.
 *
 * @explanation - Іншого рішення таймінгу анімації інтро я не знав, тому й
 * довелося шукати мінімально робоче рішення за допомогою методу життєвого
 * циклу update(). За вашою підказкою розібрався з tween, onComplete та
 * time.delayedCall, та виправив код на більш логічний з точним послідовним
 * визначенням часових проміжків. Дякую!
 *
 * ----------------------------------------------------------------------------
 *
 ...
 * одної, і по суті дублювати одна одну. Але здається я, як і у випадку з моїм
